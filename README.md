# genpark-agent-session-replay-behavioral-audit-recorder-skill
...
> **GenPark AI Agent Skill** -- Agent session replay behavioral audit recorder & anomaly detector (AgentOps)
